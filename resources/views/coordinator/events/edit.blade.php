            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-6">
                <form method="POST" action="{{ route('coordinator.events.update', $event) }}" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="category" class="block mt-1 w-full" type="text" name="category" :value="old('category', $event->category)" />
                    ...
                    <div>
                        ...
                        @if($event->banner_image)
                            <div class="mt-2 mb-4">
                                <img src="{{ Storage::url($event->banner_image) }}" alt="{{ $event->name }}" class="h-32 rounded-lg object-cover">
                            </div>
                        @endif
                    ...
                    <div>
                        ...
                        <x-text-input id="registration_deadline" class="block mt-1 w-full" type="datetime-local" name="registration_deadline" :value="old('registration_deadline', $event->registration_deadline?->format('Y-m-d\TH:i'))" />
                    ...
                    <div>
                        ...
                        <x-text-input id="contact_email" class="block mt-1 w-full" type="email" name="contact_email" :value="old('contact_email', $event->contact_email)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="contact_phone" class="block mt-1 w-full" type="text" name="contact_phone" :value="old('contact_phone', $event->contact_phone)" />
                    ...
                    <div>
                        ...
                        <textarea id="rules" name="rules" rows="3"
                                  class="block mt-1 w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-brand focus:border-brand">{{ old('rules', $event->rules) }}</textarea>
